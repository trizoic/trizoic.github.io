...
float snoise(vec2 v) {
  const vec4 C = vec4(0.211324865405187, 0.366025403784439, -0.577350269189626, 0.024390243439);
...
export default function Aurora({ colorStops = ['#7c3cff', '#56ffd2', '#ff5ca8'], amplitude = 1.15, blend = 0.55, speed = 0.7 }) {
  ...
  useEffect(() => {
    ...
    const colors = colorStops.map((hex) => { const c = new Color(hex); return [c.r, c.g, c.b]; });
  ...
  return <div className="aurora" ref={containerRef} aria-hidden="true" />;
}
